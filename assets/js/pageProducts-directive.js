 ...
 */
system.directive('pageProducts', ['$log', 'languageService', '$rootScope', 'contextService', function($log, languageService, $rootScope, contextService) {
  return {
    templateUrl: '/assets/partials/pageProducts.html',
    replace: true,
    restrict: 'E',
    transclude: false,
